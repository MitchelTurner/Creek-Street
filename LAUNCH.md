...
- [ ] Health: `GET /api/health` → `{ ok: true, phase: 15, store: "memory"|"prisma" }`
...
- [ ] Ops: staff `GET /api/ops/dashboard` returns phase 15 snapshot; `/admin/ops` loads for `staff@example.com`
